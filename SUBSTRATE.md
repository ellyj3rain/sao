...
| Training sees the actual decision moment | C79 `Organization.decisionEvidence` reconstructs one recipient's response-formation horizon by process revision and exposes later delivery/work separately; Speakeasy Record 63 requires the exact v3 namespace and actor/executor/source ownership | Durable process history remains in GraphPersistence; detached task evidence binds run/county/person/event/hour, proposal revision, feasible responses, choice and later commitment receipts | Border 190 proves decision/outcome separation and retrieval of revision 1 after revision 2. Speakeasy controls reject wrong person, stale revision, impossible option, hidden diagnosis and outcome leakage. | No loaded scene, task review or admitted row exists. The older C64 election capture remains ineligible; C79 supplies one bounded coordination evidence path, not broad action coverage or learned behavior. |
