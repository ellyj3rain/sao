...
| Speakeasy | `../zomboid-speakeasy/RECORD.md` | the dataset's source and row shape ratified (record 24); a ceiling for the inference budget measured (record 26); the first 112 rows are in `decisions/` as a proposal the operator has not ruled on (its record 28) |
