# Historical playability inventory

Preserved from the pre-consolidation tree. Its completion, engine-absence and
deployed-state claims are historical and superseded by PLAYABILITY.md and
SUBSTRATE.md. C identifiers use the former sequence. Retained for scope and
provenance, not as present behavior instructions.
