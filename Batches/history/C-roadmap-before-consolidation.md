# Scope reference before C consolidation

Preserved from the former C sequence on 2026-09-19. This retains detailed scope and its decision references. Historical completion and next-work claims are superseded by the current ROADMAP, SESSION_STATE and implementation audit. C labels in this reference use the former sequence in Batches/FORMER_LABELS.md.
...
### G1 â€” One survivor in the world
...
Threat, injury, need, travel â€” one action owns the body, executors finish, fail or
