...
| Current version | `2.6.0.1-pre-alpha` |
| Closed chronology | `A1-C34` |
| Next batch | `C35` |
...
`C35` is the next batch. Its content determines its tier after it
exists:

| If C35 is | Result |
|---|---|
| patch or hotfix | `2.6.0.2-pre-alpha` |
