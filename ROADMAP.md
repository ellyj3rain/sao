...
Broader options, curated acquisition, ratification and later consequences remain
R11-R12 work. Existing R work moves with its owning contract.
...
completion. R9 remains open for complete inventory and the other
care/provisioning/development producers. C64 closes R11's immutable
...
### Continuation after C70

| Producer | Concrete next work | Evidence required |
|---|---|---|
| Complete private inventory | Extend exact native identity and holder coverage from selected sources and personal handovers to every carried, container, vehicle and placed-item surface used by decisions; keep each person's access private and current. | Coverage matrix, holder conservation, replacement/removal, reload, loaded/dormant agreement and refusal of inferred totals. |
| Dormant spoken access | Add sleep/rest/wake transitions to the existing bodyless physiology/action owner and retain measured hearing. Older unknown state needs actual acquisition. | Same-person loaded/dormant sleep, hearing, clock and encounter tests. |
| Radio acquisition | Establish actual operating receiver, channel and recipient access for delivery/request testimony. | Reception evidence, rather than possession or membership alone. |
...
The selected native source and personal-handover item remain partial inventory.
Complete coverage and the other R9 producers retain their existing owners in
SUBSTRATE.md. C70 closes loaded open-wound treatment and its immediate
consequences. It does not close complete inventory, the other medical verbs,
dormant exchange or radio reception.
