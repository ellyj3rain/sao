...
| Sharing and exchange | Extend the existing action/result owner to completed person-to-person handovers and accepted terms. | Native conservation, partial/cancelled legs, agreement and settlement from completed results. |
...
The selected native source remains partial inventory. Complete coverage and the
other R9 producers retain their existing owners in SUBSTRATE.md. These concrete
outputs define the next dependency work; batch numbers are assigned at closure.
