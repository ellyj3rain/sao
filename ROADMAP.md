...
C79's production appraisal observer now emits exact v3 candidate rows and keeps
response delivery plus native work in a later horizon. A controlled 13-row pass
survives ZAO's same-event state projection and Speakeasy compilation. R11 still
requires broader action coverage, independent task review and loaded-world
sampling; captured coordination consequences are no longer the missing seam.
