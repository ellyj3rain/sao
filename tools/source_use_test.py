...
def production_contract(texts):
    ...
    required = [
        ...
        (world, "function WS.completedResults(consumer, includeObservations)"),
...
def contract_anchor_probe():
    ...
    controls = [
        ...
        (0, "function WS.completedResults(consumer, includeObservations)",
         "function WS.mutableResults(consumer, includeObservations)"),
