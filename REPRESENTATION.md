...
| [SAO_WorldDevelopment.lua](mod/42.20/media/lua/shared/SAO_WorldDevelopment.lua) | home, ground, larder, water, hearth, motor pool, fortification | the material state of the place this person is connected to | reports state; never builds or stocks anything |
